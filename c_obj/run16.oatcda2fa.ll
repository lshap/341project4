...
__fresh283:
  ...
  %index_ptr868 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* %array867, i32 0, i32 1, i32 0
  store i32 3, i32* %index_ptr868
  store i32 0, { i32, [ 0 x i32 ] }** %index_ptr869
...
__compare280:
  ...
  br i1 %comparison_result870, label %__body281, label %__end282
...
__body281:
  ...
  %index_ptr874 = getelementptr { i32, [ 0 x i32 ] }* %array873, i32 0, i32 1, i32 0
  store i32 3, i32* %index_ptr874
  store i32 0, i32* %index_ptr875
...
__compare277:
  ...
  br i1 %comparison_result876, label %__body278, label %__end279
...
__end282:
  ...
  store { i32, [ 0 x i32 ] }** %array867, { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a883
