...
__fresh27:
  ...
  %size_ptr93 = getelementptr { i32, [ 0 x i32 ] }* %a91, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr93, i32 2 )
  %index_ptr92 = getelementptr { i32, [ 0 x i32 ] }* %a91, i32 0, i32 1, i32 2
  %_lhs94 = load { i32, [ 0 x i32 ] }** %a91
  ret { i32, [ 0 x i32 ] }* %_lhs94
}
