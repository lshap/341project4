...
__fresh44:
  ...
  %size_ptr156 = getelementptr { i32, [ 0 x i32 ] }* @a150, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr156, i32 0 )
  %index_ptr155 = getelementptr { i32, [ 0 x i32 ] }* @a150, i32 0, i32 1, i32 0
