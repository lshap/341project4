...
__cond57:
  ...
  br i1 %bop197, label %__body56, label %__post55
...
__cond60:
  ...
  br i1 %bop200, label %__body59, label %__post58
...
__body59:
  ...
  call void @oat_array_bounds_check( i32 0, i32 %_lhs203 )
  %index_ptr205 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }** %a193, i32 %_lhs202
  call void @oat_array_bounds_check( i32 0, i32 %_lhs202 )
