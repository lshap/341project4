...
__fresh1:
  ...
  %size_ptr11 = getelementptr { i32, [ 0 x i32 ] }* @arr5, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr11, i32 1 )
  %index_ptr10 = getelementptr { i32, [ 0 x i32 ] }* @arr5, i32 0, i32 1, i32 1
  %_lhs12 = load { i32, [ 0 x i32 ] }** @arr5
  ret { i32, [ 0 x i32 ] }* %_lhs12
}
