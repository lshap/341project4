...
__fresh39:
  ...
  %size_ptr138 = getelementptr { i32, [ 0 x i32 ] }* @i132, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr138, i32 0 )
  %index_ptr137 = getelementptr { i32, [ 0 x i32 ] }* @i132, i32 0, i32 1, i32 0
