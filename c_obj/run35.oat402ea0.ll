...
__cond83:
  ...
  br i1 %bop252, label %__body82, label %__post81
...
__cond86:
  ...
  br i1 %bop255, label %__body85, label %__post84
...
__body85:
  ...
  %size_ptr260 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @a244, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr260, i32 %_lhs258 )
  %index_ptr259 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @a244, i32 0, i32 1, i32 %_lhs258
  %size_ptr262 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @a244, i32 0, i32 0
  call void @oat_array_bounds_check( i32 %size_ptr262, i32 %_lhs257 )
  %index_ptr261 = getelementptr { i32, [ 0 x { i32, [ 0 x i32 ] }* ] }* @a244, i32 0, i32 1, i32 %_lhs257
